...
system(["echo `java -jar \"../dist/ConvexHull.jar\" testrun noat 10 gift foobar no nodraw |grep Aver |cut -d ' ' -f 4` ", num2str(1000*i), " >> gift.worsttimes"]);
end
...
system(["echo `java -jar \"../dist/ConvexHull.jar\" testrun noat 10 quick foobar no nodraw |grep Aver |cut -d ' ' -f 4` ", num2str(1000*i), " >> quick.worsttimes"]);
end
...
system(["echo `java -jar \"../dist/ConvexHull.jar\" testrun noat 10 graham foobar no nodraw |grep Aver |cut -d ' ' -f 4` ", num2str(1000*i), " >> graham.worsttimes"]);
end
...
system(["echo `java -jar \"../dist/ConvexHull.jar\" testrun noat 10 quick foobar no nodraw |grep Aver |cut -d ' ' -f 4` ", num2str(100000*i), " >> quick.worsttimes"]);
end
...
system(["echo `java -jar \"../dist/ConvexHull.jar\" testrun noat 10 graham foobar no nodraw |grep Aver |cut -d ' ' -f 4` ", num2str(100000*i), " >> graham.worsttimes"]);
end
